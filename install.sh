...
LEGACY_PRESETS='project-model-router.toml project-model-router-low.toml project-model-router-high.toml project-model-router-xhigh.toml project-model-router-max.toml project-model-router-terra.toml project-model-router-terra-low.toml project-model-router-terra-high.toml project-model-router-terra-xhigh.toml project-model-router-terra-max.toml project-model-router-luna.toml project-model-router-luna-low.toml project-model-router-luna-high.toml project-model-router-luna-xhigh.toml project-model-router-luna-max.toml project-model-executor.toml project-model-executor-low.toml project-model-executor-high.toml project-model-executor-xhigh.toml project-model-executor-max.toml project-model-executor-terra.toml project-model-executor-terra-low.toml project-model-executor-terra-high.toml project-model-executor-terra-xhigh.toml project-model-executor-terra-max.toml project-model-executor-luna.toml project-model-executor-luna-low.toml project-model-executor-luna-high.toml project-model-executor-luna-xhigh.toml project-model-executor-luna-max.toml'
